...
**NOTES:**
- Watchy uses version 1.0.6 or 2.0.2 (or possibly higher than 2.0.4) of the ESP32 libraries, 2.0.0 won't compile, 2.0.3 and 2.0.4 causes a boot crash loop, remove them manually and revert back to version 1.0.6 or use 2.0.2 (which seems to have been fixed).
