...
{
public:
  PipBoyAddOnClass () : WatchyGSR () { initAddOn (this); }
        ...
        if (SafeToDraw ())
          {
            ...
            display.drawBitmap (0, 10, vaultboymenubar, 200, 9, ForeColor (),
                                BackColor ());
  ...
  drawTime ()
  {
    ...
    switch (vaultBoyNum)
      {
      case 0:
        display.drawBitmap (70, 50, vaultboy, 57, 100, ForeColor (),
                            BackColor ());
        break;
      case 1:
        display.drawBitmap (70, 50, vaultboypoint, 57, 100, ForeColor (),
                            BackColor ());
        break;
      case 2:
        display.drawBitmap (60, 50, vaultboysmile, 67, 100, ForeColor (),
                            BackColor ());
        break;
      }
    ...
    if (BMAAvailable ())
      {
        ...
        display.drawBitmap (60, 155, vaultboygauge, 73, 10, ForeColor (),
                            BackColor ());
        display.fillRect (60 + 13, 155 + 5, (progress / 2) + 5, 4,
                          ForeColor ());
      }
  }
  ...
  drawBattery ()
  {
    display.drawBitmap (10, 150, vaultboybattery, 37, 21, ForeColor (),
                        BackColor ());
    ...
    if (IsWeatherAvailable ())
      {
        ...
        display.drawBitmap (5, 85, weatherIcon, 48, 32, ForeColor (),
                            BackColor ());
