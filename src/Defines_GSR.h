...
#define GSR_MENU_BERR 36
#define GSR_MENU_UNVS 37
...
//#define GSR_APP 32    // AddOn as an App will offer menu insert.

// Weather Defines.
#define NOLOC 255     // Means no Geo Location found (255 is out of the range for Long/Lat values).
