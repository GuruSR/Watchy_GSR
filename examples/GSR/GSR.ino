...
#endif
#if __has_include("StarField_GSR_AddOn.h")
#include "StarField_GSR_AddOn.h"
#endif
#if __has_include("PipBoy_GSR_AddOn.h")
#include "PipBoy_GSR_AddOn.h"
#endif
#endif

// Place all of your data and variables here.

// RTC_DATA_ATTR uint8_t MyStyle;  // Remember RTC_DATA_ATTR for your variables
// so they don't get wiped on deep sleep.

class OverrideGSR : public WatchyGSR
{
  /*
   * Keep your functions inside the class, but at the bottom to avoid confusion.
   * Be sure to visit the Wiki at https://github.com/GuruSR/Watchy_GSR for full
   * information on how to override including functions that are available to
   * your override to enhance functionality.
   */
public:
  ...
  */
  ...
  InsertNTPServer ()
  {
    return "<your favorite ntp server address>";
  };
  */
  ...
  */
  ...
  // The next 3 functions allow you to add your own WatchFaces, there are
  // examples that do work below.
  /*
  void
  ...
  */
  ...
  /*
  void
  InsertInitWatchStyle (uint8_t StyleID)
  {
    if (StyleID == MyStyle)
      {
        Design.Menu.Top = 72;
  ...
  */
  ...
  /*
  void
  InsertDrawWatchStyle (uint8_t StyleID)
  {
    if (StyleID == MyStyle)
      {
        if (SafeToDraw ())
  ...
  */
  ...
  /*
  bool
  InsertHandlePressed (uint8_t SwitchNumber, bool &Haptic, bool &Refresh)
  {
    switch (SwitchNumber)
      {
      case 2:           // Back
        ...
        return true; // Respond with "I used a button", so the WatchyGSR knows
                     // you actually did something with a button.
        break;
      case 3: // Up
        return true;
        break;
